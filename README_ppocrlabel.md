...
python PPOCRLabel.py --lang ch  # 以中文语言运行
```
...
1. 同一个字段标记一个矩形框，例如“票据代码：33010120”；</br>
<img src="./img/fpdm.png" width="50%"/>
2. 电子发票标记字段，如下；</br>
<img src="./img/dzfpdb.png" width="100%"/>
3. 纸质发票标记字段，如下；</br>
<img src="./img/zzfpbz.png" width="100%"/>
